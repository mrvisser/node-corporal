...
var doCommandLoop = module.exports.doCommandLoop = function(session, callback) {
    ...
    getCommand(session, function(args) {
        args = _.compact(args);
        if (_.isEmpty(args)) {
...
/**
 * Get a potentially multi-line command from a user similar to a bash
 * shell.
 */
var getCommand = module.exports.getCommand = function(session, callback) {
